...
public class RegistrationRequest {
    ...
    @Schema(name = "User's username", example = "genie", type = "String")
    private String username;

    @NotBlank(message = "Please enter your email address.")
    @Pattern(regexp = "^(?=.{1,64}@)[A-Za-z0-9_-]+(\\.[A-Za-z0-9_-]+)*@[^-][A-Za-z0-9-]+(\\.[A-Za-z0-9-]+)*(\\.[A-Za-z]{2,})$",
            message = "Please enter a valid email address.")
    @Schema(name = "User's email address", example = "genie@gmail.com", type = "String")
    ...
    @Schema(name = "User's password", example = "Genie123!@", type = "String", description = "The password will be encoded with BCrypt")
    private String password;

    @NotBlank(message = "Please confirm your password.")
    @JsonProperty("confirm")
    @Schema(name = "Confirmation of the password", example = "Genie123!@", type = "String", description = "The confirm password needs to match with the password")
