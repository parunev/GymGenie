...
public class ChangePasswordRequest {
    ...
    @Schema(name = "User's old password", example = "Genie123!@", type = "String")
    ...
    @Schema(name = "User's new password", example = "Genie12345!@", type = "String")
    private String newPassword;

    @NotBlank(message = "Please confirm your new password")
    @Schema(name = "Confirmation of the new password", example = "Genie12345!@", type = "String")
