...
public class PasswordPatterns {
    ...
    public static String forgotPassword(String link) {
        return "<!DOCTYPE html>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0;\">We're here to assist you in regaining access to your account. To reset your password, simply click the button below to verify your request for a change.</p>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0;\">&nbsp;</p>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0;\"><strong>IMPORTANT: </strong>If you didn't request this email, please ignore it. Sometimes these things happen, and there's no need to worry.</p>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0;\">&nbsp;</p>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0;\">&nbsp;Here's your password reset sparkle✨</p>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t</table>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"pad\">\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"alignment\" align=\"center\"><!--[if mso]><v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"" + link + "\" style=\"height:42px;width:306px;v-text-anchor:middle;\" arcsize=\"20%\" stroke=\"false\" fillcolor=\"#000000\"><w:anchorlock/><v:textbox inset=\"0px,0px,0px,0px\"><center style=\"color:#ffffff; font-family:sans-serif; font-size:16px\"><![endif]--><a href=\"https://www.example.com\" target=\"_blank\" style=\"text-decoration:none;display:inline-block;color:#ffffff;background-color:#000000;border-radius:8px;width:auto;border-top:0px solid TRANSPARENT;font-weight:undefined;border-right:0px solid TRANSPARENT;border-bottom:0px solid TRANSPARENT;border-left:0px solid TRANSPARENT;padding-top:5px;padding-bottom:5px;font-family:Rubik, Trebuchet MS, Helvetica, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;\"><span style=\"padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;\"><span style=\"word-break: break-word; line-height: 32px;\">IT'S PASSWORD RESET PARTY TIME!</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t\t</table>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t\t</td>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0; word-break: break-word;\">This email on our top-secret super-secure app is like a sneeze in a snowstorm – it'll disappear in just 15 minutes! After that, you'll have to send us a message in a bottle \uD83C\uDF7E</p>\n" +
        ...
        public static final String RESET_PASSWORD = """
                    ...
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class="pad" style="padding-bottom:10px;padding-left:15px;padding-right:15px;padding-top:10px;">
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div style="color:#ffffff;font-family:Rubik, Trebuchet MS, Helvetica, sans-serif;font-size:22px;line-height:150%;text-align:center;mso-line-height-alt:33px;">
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0;">DID YOU CHANGE YOUR <strong>PASSWORD?</strong></p>
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
                    \t\t\t\t\t\t\t\t\t\t\t\t\t</table>
                    ...
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class="pad">
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div style="color:#ffffff;font-family:Rubik, Trebuchet MS, Helvetica, sans-serif;font-size:14px;line-height:180%;text-align:center;mso-line-height-alt:25.2px;">
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0;">We're here to inform you that your password has been successfully changed. If you initiated this change, there's nothing more to do.&nbsp;</p>
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0;">&nbsp;</p>
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0;"><strong>IMPORTANT: </strong>However, if you did not request this change, please contact us immediately. Your account's security is our top priority.</p>
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
                    \t\t\t\t\t\t\t\t\t\t\t\t\t</table>
    ...
    public static final String PROFILE_PASSWORD_CHANGE = """
            <!DOCTYPE html>
            <html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en">
            ...
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class="pad" style="padding-bottom:10px;padding-left:15px;padding-right:15px;padding-top:10px;">
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div style="color:#ffffff;font-family:Rubik, Trebuchet MS, Helvetica, sans-serif;font-size:22px;line-height:150%;text-align:center;mso-line-height-alt:33px;">
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0;">Greetings, Password Pioneer!</p>
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
            \t\t\t\t\t\t\t\t\t\t\t\t\t</table>
            ...
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class="pad">
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div style="color:#ffffff;font-family:Rubik, Trebuchet MS, Helvetica, sans-serif;font-size:14px;line-height:180%;text-align:center;mso-line-height-alt:25.2px;">
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0;">Well, well, it looks like someone's feeling adventurous and decided to shake things up with a password change request for their <strong>GymGenie</strong> account. \uD83E\uDD13\uD83C\uDF89</p>
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0;">&nbsp;</p>
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0;"><strong>IMPORTANT:</strong> If you're scratching your head, wondering, "What's this password change?" and you didn't initiate it, don't sweat it –<span style="color: #ffffff;"> <strong><a href="mailto:parunev@gmail.com?subject=(User)%20Someone%20initiated%20a%20password%20change%20via%20my%20profile!" target="_blank" title="parunev@gmail.com" rel="noopener" style="text-decoration: underline; color: #8a3b8f;">CONTACT US!</a></strong></span></p>
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0;">&nbsp;</p>
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style="margin: 0;">Your peace of mind is our top priority.</p>
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
            \t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
            \t\t\t\t\t\t\t\t\t\t\t\t\t</table>
