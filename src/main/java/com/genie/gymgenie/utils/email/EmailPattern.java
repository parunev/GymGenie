...
public class EmailPattern {
    ...
    public static String changeEmail(String link){
        return "<!DOCTYPE html>\n" +
               ...
               "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0;\">Is your <strong>Email Change</strong> request almost complete?</p>\n" +
               "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n" +
               "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\n" +
               "\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n" +
               "\t\t\t\t\t\t\t\t\t\t\t\t\t</table>\n" +
               ...
               "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0;\">We understand that sometimes you want to make changes on your own terms. That's why we're here to assist you. You're in control of your GymGenie experience, and we're thrilled to support your choices!</p>\n" +
               "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0;\">&nbsp;</p>\n" +
               "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0;\">Here's your email update confirmation.</p>\n" +
               "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n" +
               "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\n" +
               "\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n" +
               "\t\t\t\t\t\t\t\t\t\t\t\t\t</table>\n" +
               ...
               "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin: 0; word-break: break-word;\">It's crucial to know that this confirmation is only valid for 30 minutes from the time of receipt. After this window, the email change process will not proceed. So, let's make it happen within that timeframe to ensure your email gets updated! \uD83D\uDE04\uD83D\uDD50</p>\n" +
